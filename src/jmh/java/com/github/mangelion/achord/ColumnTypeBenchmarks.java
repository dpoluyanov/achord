 ...
 */
@Fork(value = 1, jvmArgs = {"-server"/*, "-XX:+UnlockDiagnosticVMOptions", "-XX:+PrintAssembly", "-XX:PrintAssemblyOptions=intel,hsdis-help"*/})
...
public class ColumnTypeBenchmarks {
    ...
    public void setup(Blackhole bh) {
        ...
        buf = new DiscardByteBuf(bh);
        type = 3;
    }

    @Benchmark
    public void write() {
        ColumnType.write(type, data[0], buf);
    }

    static class DiscardByteBuf extends ByteBuf {

        private final Blackhole bh;

        DiscardByteBuf(Blackhole bh) {
            this.bh = bh;
        }
